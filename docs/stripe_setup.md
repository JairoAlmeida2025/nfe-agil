----- 1.2 - Criando as Variaveis de Ambiente - Stripe
...
IMPORTANTE: Webhook Obrigatório para Atualização Automática de Planos
...
URL do endpoint: https://nfe-agil.vercel.app/api/stripe/webhook
